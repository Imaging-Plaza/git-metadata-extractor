...
Wraps :func:`src.v2.agents.llm.agent_tools.selenium_fetch.fetch_link_content_via_selenium`.
...
from src.v2.skills._runtime import SkillError, emit_error, emit_success
