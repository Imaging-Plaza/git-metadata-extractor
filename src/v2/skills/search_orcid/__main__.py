...
Wraps :class:`src.v2.ingest.providers.orcid_rag.OrcidRagProvider`. The
same provider powers the in-process LLM agent tool in
`src/v2/agents/llm/agent_tools/orcid_rag.py`.
"""
...
from src.v2.ingest.providers.orcid_rag import build_default_provider
