...
Wraps :class:`src.v2.ingest.providers.ror_rag.RorRagProvider`. The same
provider powers the in-process LLM agent tool in
`src/v2/agents/llm/agent_tools/ror_rag.py` — this skill only changes the
...
from src.v2.ingest.providers.ror_rag import build_default_provider
