"""Adapter wrapping `src.index.gitlab_datascience_groups` for federated search/lookup."""
...
class GitLabDatascienceGroupsAdapter:
    ...
    def search(
        ...
        *,
        ...
        try:
            from src.index.gitlab_datascience_groups.retrieval import search  # noqa: PLC0415, I001
    ...
    def lookup(self, identifier: str) -> list[EntityRecord]:  # noqa: PLR0911
        ...
        if host != "gitlab.datascience.ch":
            return []
        try:
            from src.index.gitlab_datascience_groups.store import open_store  # noqa: PLC0415, I001
        except Exception:  # noqa: BLE001
            return []
        store = None
        try:
