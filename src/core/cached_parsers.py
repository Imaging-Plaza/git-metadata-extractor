...
class CachedGitHubUsersParser(GitHubUsersParser):
    ...
    def get_user_metadata_cached(self, username: str, force_refresh: bool = False) -> GitHubUserMetadata:
        """
...
class CachedGitHubOrganizationsParser(GitHubOrganizationsParser):
    ...
    def get_organization_metadata_cached(self, org_name: str, force_refresh: bool = False) -> GitHubOrganizationMetadata:
        """
...
def parse_github_user_cached(username: str, force_refresh: bool = False) -> GitHubUserMetadata:
...
def parse_github_organization_cached(org_name: str, force_refresh: bool = False) -> GitHubOrganizationMetadata:
