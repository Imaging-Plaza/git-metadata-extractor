...
from git_metadata_extractor.providers.detection import GitHubURLType, classify_github_url
...
def test_user_url_detected_from_single_path_segment(
    ...
    monkeypatch.setattr(
        "git_metadata_extractor.providers.detection.github_url_classifier._probe_account_type",
        lambda _name: "User",
    )
