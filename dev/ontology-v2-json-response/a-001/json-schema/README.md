# JSON Schema for Open Pulse Ontology v2.1.2

This folder contains JSON Schema (draft-07) definitions for validating JSON responses conforming to the [Open Pulse Ontology v2.1.2](../open-pulse-ontology-v2.1.2.ttl) SHACL shapes.
...
Based on the Open Pulse Ontology v2.1.2 SHACL constraints, each shape has specific required fields (minCount ≥ 1):
