...
| [`conversion-test.md`](conversion-test.md) + [`build_instance_example.py`](build_instance_example.py) | **The measurement**: real data from **all seven platforms** converted to the raw profile and SHACL-validated — 38 violations as published, 0 with the asks applied. |
