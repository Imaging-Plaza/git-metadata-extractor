...
from git_metadata_extractor.agents.llm.agent_tools.graph_neighbors import make_get_entity_neighbors_tool
from git_metadata_extractor.agents.llm.refiners import (
...
from git_metadata_extractor.agents.llm.refiners.discovery import (
    DiscoveredArticle,
    DiscoveredOrg,
    DiscoveredPerson,
...
from git_metadata_extractor.agents.llm.refiners.org_resolver import (
    OrgResolverAgent,
    OrgResolverInput,
    OrgResolverPatch,
    UnresolvedOrg,
)
from git_metadata_extractor.agents.llm.refiners.repo_signals.agent import (
    RepoSignalsInput,
    run_repo_signals,
)
from git_metadata_extractor.agents.llm.refiners.rescue import (
    RescueCandidate,
    RescueRefinerAgent,
    RescueRefinerInput,
)
...
from git_metadata_extractor.api_models.enums import OrganizationTypeV2
...
async def _run_org_resolver_pass(
    *,
    ...
    from git_metadata_extractor.agents.llm.agent_tools.github_organization import (  # noqa: PLC0415
    ...
    from git_metadata_extractor.agents.llm.agent_tools.snsf_grants import (  # noqa: PLC0415
        make_search_snsf_grants_tool,
    )
    from git_metadata_extractor.providers.snsf_grants import SnsfGrantsProvider  # noqa: PLC0415
