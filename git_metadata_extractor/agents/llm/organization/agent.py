...
from git_metadata_extractor.schema.models.agent import AgentOrganizationShape
from git_metadata_extractor.schema.models.strict import OrganizationModel
