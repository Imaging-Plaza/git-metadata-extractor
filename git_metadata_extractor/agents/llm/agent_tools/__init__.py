...
from git_metadata_extractor.agents.llm.agent_tools.disciplines import list_disciplines_tool
from git_metadata_extractor.agents.llm.agent_tools.duckduckgo_search import (
    make_duckduckgo_search_tool,
)
from git_metadata_extractor.agents.llm.agent_tools.email_hash import (
    hash_user_email,
...
from git_metadata_extractor.agents.llm.agent_tools.federated_rag import (
...
from git_metadata_extractor.agents.llm.agent_tools.huggingface_lineage import (
...
from git_metadata_extractor.agents.llm.agent_tools.infoscience_orgunit import (
    make_infoscience_orgunit_tool,
)
from git_metadata_extractor.agents.llm.agent_tools.infoscience_publications import (
...
from git_metadata_extractor.agents.llm.agent_tools.infoscience_search import (
    make_infoscience_search_tool,
)
from git_metadata_extractor.agents.llm.agent_tools.openalex_rag import (
...
from git_metadata_extractor.agents.llm.agent_tools.orcid_rag import (
    make_orcid_rag_search_tool,
)
from git_metadata_extractor.agents.llm.agent_tools.renkulab_rag import (
...
from git_metadata_extractor.agents.llm.agent_tools.ror_organization import (
    make_ror_organization_search_tool,
)
from git_metadata_extractor.agents.llm.agent_tools.ror_rag import (
...
from git_metadata_extractor.agents.llm.agent_tools.snsf_rag import (
...
from git_metadata_extractor.agents.llm.agent_tools.zenodo_rag import (
    make_zenodo_rag_fetch_records_tool,
    make_zenodo_rag_search_tool,
)
from git_metadata_extractor.agents.llm.agent_tools.github_rag import (
