...
from git_metadata_extractor.schema.models.agent import AgentRepositoryShape
from git_metadata_extractor.schema.models.strict import RepositoryModel

MIN_REPOSITORY_SEGMENTS = 2
README_CONTENT_MAX_CHARS = 4000
GIMIE_JSONLD_MAX_CHARS = 8000

_PROMPTS_PACKAGE = "git_metadata_extractor.agents.llm.repository.prompts"
