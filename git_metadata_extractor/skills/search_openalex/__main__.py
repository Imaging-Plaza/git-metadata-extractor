...
Wraps :class:`git_metadata_extractor.providers.openalex_rag.OpenAlexRagProvider`.
...
from git_metadata_extractor.providers.openalex_rag import build_default_provider
