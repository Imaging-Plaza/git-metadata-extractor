...
def _run_awaitable(value: Coroutine[Any, Any, ResponseT]) -> ResponseT:
    ...
    See `git_metadata_extractor/providers/infoscience_provider.py:_run_async` for why
...
class BaseProvider:
    ...
    def __init__(
        ...
        *,
        ...
        from git_metadata_extractor.providers.rate_limiter import RateLimiter  # noqa: PLC0415
