...
from git_metadata_extractor.providers.github_token_pool import (
...
class RealGitHubProvider(GitHubProvider):
    ...
    def _resolve_user_lookup(self) -> UserLookup:
        ...
        if self._users_parser is None:
            from git_metadata_extractor.providers.github_accounts.users_parser import GitHubUsersParser  # noqa: PLC0415
    ...
    def _resolve_organization_lookup(self) -> OrganizationLookup:
        ...
        if self._orgs_parser is None:
            from git_metadata_extractor.providers.github_accounts.orgs_parser import (  # noqa: PLC0415
