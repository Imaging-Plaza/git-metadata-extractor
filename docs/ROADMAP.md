...
- **2026-05-02 afternoon**: `src/index/_federated/` shipped with 6 adapters; `gme search` / `gme entity` / `gme indices` CLIs; `FederatedRagProvider` + `search_federated_rag` + `lookup_entity_federated` v2 LLM agent tools; full docs ([`federated-search.md`](https://github.com/caviri/open-pulse-sources/blob/main/docs/federated-search.md), [`rag-indices.md`](https://github.com/caviri/open-pulse-sources/blob/main/docs/rag-indices.md), this file).
