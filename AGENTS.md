...
- Current entry task: `.internal/v2b-plan/phase-3-validation-reconciliation/P2B-16-reconciliation-primary-class-outputs.md` (v2b Phase 2 tasks `P2B-11` through `P2B-15` complete; scoped `tests/v2` runs are green except expected extract-golden fixture drift pending phase-6 docs/regression refresh).
