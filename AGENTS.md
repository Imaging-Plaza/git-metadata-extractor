...
- Current entry task: `.internal/v2b-plan/phase-4-output-contracts/P2B-20-jsonld-build-stage.md` (v2b Phase 3 tasks `P2B-16` through `P2B-19` complete and validated in scoped `tests/v2` runs).
