...
- Current entry task: `.internal/v2-plan/phase-4-graph-store/P4-09-intermediate-snapshots.md` (Phase 3 tasks `P3-01` through `P3-08` complete; `P4-01` through `P4-08` complete and validated in scoped `tests/v2` runs).
